...
extension AppDelegate {
    func initCoordinator() {
        ...
        let navigaitonController = UINavigationController.init()
        let router = Router.init(navigationController: navigaitonController)
        
        window.rootViewController = navigaitonController
        
        let dp = AppCoordinator.Dependencies(
            coordinatorFactory: CoordinatorFactory() )
        appCoordinator = AppCoordinator.init(router: router, dependencies: dp)
